...
export const faqContent = {
  ...
  zh: {
    title: "常见问题",
    subtitle: "以下是关于我们的常见问题解答。",
    stillHaveQuestions: "还有疑问？",
    stillHaveDesc: "没有找到您想要的答案？欢迎与我们友好的团队取得联系！",
    scheduleCall: "预约通话",
    items: [
      {
        question: "起订量是多少？",
        answer:
          "最低订货量为每款每色 3,000 件。小批量订单也可接受，但单价会相应提高。",
      },
      {
        question: "你们接受哪些付款方式？",
        answer:
          "公司在开始生产前需要 30% 的预付款。订单完工后，客户在提货前支付剩余 70%。",
      },
      {
        question: "你们能为我们以自有品牌生产产品吗？",
        answer: "可以，我们完全可以为您的品牌进行贴牌生产。",
      },
      {
        question: "付款后生产需要多长时间？",
        answer:
          "通常生产周期为付款后 2 至 2.5 个月，紧急订单可单独协商加急安排。",
      },
      {
        question: "在订单与生产过程中，谁会与我们对接？",
        answer:
          "首先会准备并确认样品，随后由专属销售经理在整个生产周期提供日常沟通与支持。",
      },
      {
        question: "你们能为我们定制专属设计吗？",
        answer:
          "当然可以。如果您需要个性化设计，我们可以为您专门开发，并可签订独家品牌协议以保护您的设计权益。",
      },
    ] satisfies FaqItem[],
  },
} as const;
