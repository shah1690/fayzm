...
export const businesses: BusinessData[] = [
  {
    ...
    heading: {
      ...
      uz: "Har qanday ehtiyoj uchun sifatli trikotaj",
    ...
    cardHeading: {
      en: "4,000 Tons Annual Fabric Production",
      uz: "Yiliga 4 000 tonna mato",
      ru: "4 000 тонн тканей в год",
    },
    cardText: {
    ...
    strategyHeading: {
      ...
      uz: "Ishlab chiqarish imkoniyatlari va investitsiya",
    ...
    features: [
      {
        en: "USD 3 million invested in modern equipment (2012–2017)",
        uz: "2012–2017 yillarda zamonaviy jihozlarga 3 mln USD investitsiya",
        ru: "Инвестиции 3 млн USD в современное оборудование (2012–2017)",
      },
      {
        en: "Partnered with TAYFAN, HonKnit & Boosan",
        uz: "TAYFAN, HonKnit va Boosan bilan hamkorlik",
        ru: "Партнёрство с TAYFAN, HonKnit и Boosan",
      },
      {
        en: "4,000 tons of quality fabric produced annually",
        uz: "Yiliga 4 000 tonna sifatli mato ishlab chiqariladi",
        ru: "4 000 тонн качественных тканей в год",
      },
      {
  ...
  },
  {
    ...
    heading: {
      en: "5,400 Tons of Combed Yarn Per Year",
      uz: "Yiliga 5 400 tonna taralgan ip",
      ru: "5 400 тонн гребенной пряжи в год",
    },
    description: {
    ...
    cardHeading: {
      en: "5,400 Tons of Combed Yarn Annually",
      uz: "Yiliga 5 400 tonna taralgan ip",
      ru: "5 400 тонн гребенной пряжи в год",
    },
    cardText: {
    ...
    features: [
      {
        en: "USD 15 million investment (USD 12M bank + USD 3M own funds)",
        uz: "15 mln USD investitsiya (12 mln bank + 3 mln o'z mablag'lari)",
        ru: "Инвестиции 15 млн USD (12 млн банк + 3 млн собственные)",
      },
      {
      ...
      {
        en: "Supplies yarn to internal knitting and weaving divisions",
        uz: "Ichki trikotaj va to'quv bo'limlariga ip yetkazadi",
        ru: "Поставляет пряжу во внутренние трикотажные и ткацкие подразделения",
      },
    ],
    image1: img.y1,
    image2: img.y2,
  ...
  },
  {
    ...
    heading: {
      en: "7 Million Garments Produced Annually",
      uz: "Yiliga 7 million dona kiyim",
      ru: "7 миллионов изделий в год",
    },
    description: {
    ...
    features: [
      {
        en: "~7 million finished knitwear units produced annually",
        uz: "Yiliga taxminan 7 million dona tayyor trikotaj mahsulot",
        ru: "~7 миллионов готовых трикотажных изделий в год",
      },
      {
  ...
  },
  {
    ...
    heading: {
      en: "Up to 50 Tons of Wheat Milled Daily",
      uz: "Kuniga 50 tonnagacha bug'doy tortiladi",
      ru: "До 50 тонн пшеницы в сутки",
    },
    description: {
    ...
    cardHeading: {
      en: "1,125 Tons of Flour Per Month",
      uz: "Oyiga 1 125 tonna un",
      ru: "1 125 тонн муки в месяц",
    },
    cardText: {
    ...
    strategyHeading: {
      ...
      uz: "Daladam tegirmongacha integratsiya",
    ...
    features: [
      {
        en: "USD 370,000 invested (launched 2022)",
        uz: "370 000 USD investitsiya (2022 yilda ishga tushirildi)",
        ru: "Инвестиции 370 000 USD (запущено в 2022)",
      },
      {
        en: "50 tons of wheat processed daily, 1,125 tons of flour monthly",
        uz: "Kuniga 50 tonna bug'doy, oyiga 1 125 tonna un",
        ru: "50 тонн пшеницы в сутки, 1 125 тонн муки в месяц",
      },
      {
        en: "50 employees, wheat sourced from cluster's own farm",
        uz: "50 xodim, bug'doy klasterning o'z fermasidan",
  ...
  },
  {
    ...
    cardHeading: {
      ...
      uz: "Strategik yoqilg'i infratuzilmasi",
    ...
    strategyHeading: {
      en: "Self-Financed Cluster Infrastructure",
      uz: "O'z mablag'lari bilan moliyalashtirilgan klaster infratuzilmasi",
      ru: "Инфраструктура кластера за счёт собственных средств",
    },
    strategyDesc: {
    ...
    features: [
      {
        en: "4 billion UZS invested, fully self-financed",
        uz: "4 milliard so'm investitsiya, to'liq o'z mablag'lari",
        ru: "Инвестиции 4 млрд сум из собственных средств",
      },
      {
  ...
  },
  {
    ...
    heading: {
      ...
      uz: "Zokirjon Ota — Chorvachilik va Dehqonchilik",
    ...
    features: [
      {
        ...
        uz: "Shveytsariya va Niderlandiyadan 200 zotli sigir + 100 buqa",
        ru: "200 племенных коров + 100 быков из Швейцарии и Нидерландов",
      },
      {
        en: "600 fine-wool sheep + 10 mares & stallions from Poland",
        uz: "600 ingichka junli qo'y + Polshadan 10 baytal va ot",
        ru: "600 тонкорунных овец + 10 кобыл и жеребцов из Польши",
      },
      {
  ...
  },
  {
    ...
    heading: {
      ...
      uz: "Yiliga 7 300 tonna g'o'za moyi",
    ...
    features: [
      {
        ...
        uz: "Yiliga 7 300 tonna tozalangan g'o'za moyi",
        ru: "7 300 тонн рафинированного хлопкового масла в год",
      },
      {
        en: "Raw cotton sourced from FAYZ-M's own farm fields",
        uz: "Xom paxta FAYZ-M ning o'z ferma dalalaridan olinadi",
        ru: "Хлопок-сырец с собственных полей фермы FAYZ-M",
      },
      {
        en: "By-products (meal, hulls) used as animal feed — zero waste",
        uz: "Qo'shimcha mahsulotlar (un, qobiq) hayvon ozuqasi — chiqindisiz",
