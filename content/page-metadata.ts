...
export const pageMetadata = {
  about: {
    ...
    description: {
      ...
      zh: "了解 FAYZ-M——位于乌兹别克斯坦的垂直一体化纺织产业集群，涵盖生产、绿色能源及出口能力。",
    },
  },
  businesses: {
    heading: {
    ...
    description: {
      ...
      zh: "了解 FAYZ-M 的业务板块：针织、纱线、服装、面粉、棉籽油、加油站及畜牧业。",
    },
  },
  collections: {
    heading: {
    ...
    description: {
      ...
      zh: "探索 FAYZ-M 男女款针织与服装系列——在乌兹别克斯坦生产，面向全球市场。",
    },
  },
  collectionsMen: {
    heading: {
    ...
    description: {
      ...
      zh: "浏览 FAYZ-M 男装针织与服装款式——采用优质面料，达到出口级生产品质。",
    },
  },
  collectionsWomen: {
    heading: {
    ...
    description: {
      ...
      zh: "浏览 FAYZ-M 女装针织与服装款式——兼顾舒适、品质，专为国际订单打造。",
    },
  },
  contact: {
    heading: {
    ...
    description: {
      ...
      zh: "如需了解生产、出口订单、合作与业务洽谈，欢迎联系 FAYZ-M。",
    },
  },
  faq: {
    heading: {
    ...
    description: {
      ...
      zh: "解答关于 FAYZ-M 订单、自有品牌生产、样品、设计及合作条款的常见疑问。",
    },
  },
