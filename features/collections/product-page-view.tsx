...
const t = {
  ...
  fabric: { en: "Fabric", uz: "Mato", ru: "Ткань", zh: "Fabric" },
  composition: {
    en: "Composition",
    uz: "Tarkib",
    ru: "Состав",
  ...
  weight: { en: "Weight", uz: "Og'irlik", ru: "Вес", zh: "Weight" },
  sizes: {
    en: "Available Sizes",
  ...
  ctaSub: {
    ...
    zh: "We'll get back to you within 24 hours",
  },
  collections: {
    en: "Collections",
    uz: "Kolleksiyalar",
...
const specTranslations = {
  ...
  Fleece: { en: "Fleece", uz: "Flis", ru: "Флис", zh: "Fleece" },
  "100% cotton": {
    en: "100% cotton",
    uz: "100% paxta",
    ru: "100% хлопок",
