...
const divisions = [
  ...
  },
  {
    ...
    title: { en: "Yarn Production", uz: "Ip ishlab chiqarish", ru: "Производство пряжи" },
    desc: {
  ...
  },
  {
    ...
    title: { en: "Garment Production", uz: "Tikuvchilik", ru: "Швейное производство" },
    desc: {
  ...
  },
  {
    ...
    title: { en: "Flour Production", uz: "Un ishlab chiqarish", ru: "Производство муки" },
    desc: {
  ...
  {
    slug: "petrol",
    label: { en: "Petrol Station", uz: "Yoqilg'i stansiyasi", ru: "Автозаправка" },
    title: { en: "Petrol Station", uz: "Yoqilg'i stansiyasi", ru: "Автозаправка" },
    desc: {
  ...
  },
  {
    ...
    title: { en: "Farm & Agriculture", uz: "Dehqonchilik", ru: "Сельское хозяйство" },
    desc: {
    ...
    <section className="bg-white py-16 md:py-24">
      <div className="mx-auto max-w-[1440px] px-5 md:px-10">
        ...
        <div className="mb-14 flex flex-col items-center gap-3 text-center">
          <h2 className="text-3xl md:text-4xl">{sectionContent.heading[locale]}</h2>
          ...
          {divisions.map((div) => (
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                <p className="font-semibold text-[#070A0F]">{div.title[locale]}</p>
                <p className="text-sm leading-relaxed text-gray-500">{div.desc[locale]}</p>
              </div>
            </Link>
          ))}
        </div>
