      ...
      <div className="mx-auto max-w-[1440px]">
        <div className="relative overflow-hidden" style={{ borderRadius: 40, minHeight: 460 }}>
          ...
          <div
            ...
            style={{ background: "linear-gradient(45deg, #84CC16 0%, rgba(132,204,22,0.7) 40%, rgba(0,0,0,0.3) 100%)" }}
          />
          ...
          <div className="relative z-10 flex h-full flex-col justify-between p-10 md:p-14" style={{ minHeight: 460 }}>
            ...
            <div className="flex max-w-xl flex-col gap-4">
              <h2 className="text-3xl font-bold text-white md:text-4xl">{text.heading[locale]}</h2>
              <p className="text-sm leading-relaxed text-white/80">{text.desc[locale]}</p>
              <Link
                href="/contact"
