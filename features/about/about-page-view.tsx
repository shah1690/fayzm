...
const images = [
  { src: "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&h=500&fit=crop", alt: "Team member" },
  { src: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=400&h=500&fit=crop", alt: "Office space" },
  { src: "https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=400&h=500&fit=crop", alt: "Work environment" },
  { src: "https://images.unsplash.com/photo-1556761175-4b46a572b786?w=400&h=500&fit=crop", alt: "Team collaboration" },
];
          ...
          <div className="grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-20">
            ...
            <div className="flex flex-col justify-end gap-4">
              <svg width="48" height="40" viewBox="0 0 48 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0 40V24C0 17.333 1.667 11.833 5 7.5C8.333 3.167 13.333 0.667 20 0V6.5C16.667 7.167 14.083 8.75 12.25 11.25C10.417 13.75 9.5 16.667 9.5 20H20V40H0ZM28 40V24C28 17.333 29.667 11.833 33 7.5C36.333 3.167 41.333 0.667 48 0V6.5C44.667 7.167 42.083 8.75 40.25 11.25C38.417 13.75 37.5 16.667 37.5 20H48V40H28Z" fill="#E9E9E9"/>
              </svg>
              <p className="text-body-lg leading-relaxed text-grey-500">
                <strong className="font-semibold text-grey-800">We partner with growth-focused organizations to transform strategy into measurable performance.</strong>{" "}
                <span className="text-primary-400">Through structured planning, operational clarity, and disciplined execution, we help businesses build sustainable success.</span>
              </p>
            </div>
          </div>
